...
static const int speaker_map[][2] = {
  {PA_CHANNEL_POSITION_MONO,                    MP_SPEAKER_ID_FRONT_CENTER},
  {PA_CHANNEL_POSITION_FRONT_LEFT,              MP_SPEAKER_ID_FRONT_LEFT},
  {PA_CHANNEL_POSITION_FRONT_RIGHT,             MP_SPEAKER_ID_FRONT_RIGHT},
  {PA_CHANNEL_POSITION_FRONT_CENTER,            MP_SPEAKER_ID_FRONT_CENTER},
  {PA_CHANNEL_POSITION_REAR_CENTER,             MP_SPEAKER_ID_BACK_CENTER},
  {PA_CHANNEL_POSITION_REAR_LEFT,               MP_SPEAKER_ID_BACK_LEFT},
  {PA_CHANNEL_POSITION_REAR_RIGHT,              MP_SPEAKER_ID_BACK_RIGHT},
  {PA_CHANNEL_POSITION_LFE,                     MP_SPEAKER_ID_LOW_FREQUENCY},
  {PA_CHANNEL_POSITION_FRONT_LEFT_OF_CENTER,    MP_SPEAKER_ID_FRONT_LEFT_OF_CENTER},
  {PA_CHANNEL_POSITION_FRONT_RIGHT_OF_CENTER,   MP_SPEAKER_ID_FRONT_RIGHT_OF_CENTER},
  {PA_CHANNEL_POSITION_SIDE_LEFT,               MP_SPEAKER_ID_SIDE_LEFT},
  {PA_CHANNEL_POSITION_SIDE_RIGHT,              MP_SPEAKER_ID_SIDE_RIGHT},
  {PA_CHANNEL_POSITION_TOP_CENTER,              MP_SPEAKER_ID_TOP_CENTER},
  {PA_CHANNEL_POSITION_TOP_FRONT_LEFT,          MP_SPEAKER_ID_TOP_FRONT_LEFT},
  {PA_CHANNEL_POSITION_TOP_FRONT_RIGHT,         MP_SPEAKER_ID_TOP_FRONT_RIGHT},
  {PA_CHANNEL_POSITION_TOP_FRONT_CENTER,        MP_SPEAKER_ID_TOP_FRONT_CENTER},
  {PA_CHANNEL_POSITION_TOP_REAR_LEFT,           MP_SPEAKER_ID_TOP_BACK_LEFT},
  {PA_CHANNEL_POSITION_TOP_REAR_RIGHT,          MP_SPEAKER_ID_TOP_BACK_RIGHT},
  {PA_CHANNEL_POSITION_TOP_REAR_CENTER,         MP_SPEAKER_ID_TOP_BACK_CENTER},
...
static int init(struct ao *ao, char *params)
{
    ...
    if (!chmap_pa_from_mp(&map, &ao->channels)) {
        ...
        // channel map is valid, nut unsupported by the output device.
